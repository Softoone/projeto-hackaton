            ...
            <tbody>
              {
                ...
                Clientes.map((Cliente, index) => (
                  <tr>
                    ...
                    <td>{Cliente.nomeFreelance}</td>
                    <td>{Cliente.cidadeFreelance}</td>
                    <td>{Cliente.email}</td>
                    <td>{Cliente.meiFreelance}</td>
                    <td>{Cliente.telefoneFreelance}</td>
                    <td>{Cliente.servicoFreelance}</td>
                    <td>{Cliente.paisFreelance}</td>
                    <td>{Cliente.especialidadeFreelance}</td>
