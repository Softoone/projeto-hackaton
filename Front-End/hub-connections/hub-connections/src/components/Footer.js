            ...
            <div className="row">
              ...
              <div class="col-lg-3 col-md-6 footer-links ">
                ...
                <ul className="list-ul-Footer">
                  ...
                  <li className="list-li-Footer"><i class="bx bx-chevron-right"></i> <a className="text-secondary text-decoration-none"rel="noopener noreferrer" target="_blank" href="https://github.com/">Caio</a></li>
                  <li className="list-li-Footer"><i class="bx bx-chevron-right"></i> <a className="text-secondary text-decoration-none"rel="noopener noreferrer" target="_blank" href="https://github.com/Softoone">Guilherme</a></li>
                  <li className="list-li-Footer"><i class="bx bx-chevron-right"></i> <a className="text-secondary text-decoration-none"rel="noopener noreferrer" target="_blank" href="https://github.com/LUANSSA">Luan</a></li>
